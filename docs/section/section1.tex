...
Furthermore, in Fig.~\ref{fig:darkMatter}b, metagenomes
exhibit superlinear growth, indicating that newly added datasets contribute
disproportionately many novel protein families. Hence, it makes more sense to
limit our investigation on reference genomes which are computationally more
stable and predictable in sequence alignment and clustering.
