...
The largest connected subgraphs (Fig.~\ref{fig:graph}) compare TaxID-based coloring (left) against MCL communities (right) with inflation parameter 1.2. The MCL partitions tends to resemble the taxonomic groupings, indicating that the algorithm partially recovers organism-level clusters. White lines separate organism-level partitions.
