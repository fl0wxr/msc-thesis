...
Smoothed sequence length distributions for \texttt{hds_prot} and \texttt{hac_prot} are shown in Fig.~\ref{fig:len_freq}. Each dataset is composed of multiple organisms, and the length distributions reflect this composition: distinct peaks corresponding to each constituent proteome are clearly observed.
