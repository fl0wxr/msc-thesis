...
Smoothed sequence length distributions for \texttt{hds\_prot} and \texttt{hac\_prot} are shown in Fig.~\ref{fig:len_freq}. Both datasets exhibit unimodal distributions, with peak lengths and occurrence frequencies listed in the respective subcaptions.
...
\begin{figure}[htbp]
  \centering
  \hspace*{0.0cm}\includegraphics[width=1\linewidth]{asset/adj_hds_hac.png}
  ...
  partitions.  For the \texttt{hds\_prot\_small} dataset: \textit{Homo sapiens}
  (human), \textit{Danio rerio} (zebrafish), and \textit{Saccharomyces
  cerevisiae} (fungus). For the \texttt{hac\_prot\_small} dataset: \textit{Homo
...
\begin{figure}[htbp]
  ...
  \begin{adjustwidth}{-0cm}{-0cm}
    ...
    \begin{subfigure}{0.44\linewidth}
      \fcolorbox{lightgray}{white}{\includegraphics[width=\linewidth]{asset/graph_hac_small_taxid.png}}
    ...
    \hspace{0.5cm}
    \begin{subfigure}{0.44\linewidth}
      \fcolorbox{lightgray}{white}{\includegraphics[width=\linewidth]{asset/graph_hac_small_mcl_1_2.png}}
    ...
    \begin{subfigure}{0.44\linewidth}
      \fcolorbox{lightgray}{white}{\includegraphics[width=\linewidth]{asset/graph_hds_small_taxid.png}}
      \subcaption{Taxonomic classification of the dataset
    ...
    \hspace{0.5cm}
    \begin{subfigure}{0.44\linewidth}
      \fcolorbox{lightgray}{white}{\includegraphics[width=\linewidth]{asset/graph_hds_small_mcl_1_2.png}}
